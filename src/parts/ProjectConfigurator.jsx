...
import { Home, Calendar, Sparkles, MapPin, CheckCircle2, Ruler, MousePointer2 } from "lucide-react";
...
export const ProjectConfigurator = () => {
  ...
  return (
    <section id="configurator" className="bg-[#f9fafb] py-24 lg:py-32 relative overflow-hidden">
      {/* Background Accents */}
      <div className="absolute top-[20%] right-0 w-[400px] h-[400px] bg-[#C9A961]/5 blur-[120px] rounded-full pointer-events-none"></div>
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1 space-y-16">
            <header className="space-y-4">
              ...
              <p className="text-gray-500 text-lg max-w-xl font-medium">
                Design your premium flooring project in seconds. Our real-time engine handles the math for you.
              </p>
            </header>
            ...
            <div className="space-y-8">
              ...
              <div className="grid sm:grid-cols-3 gap-5">
                {options.map((option) => (
                  ...
                  >
                    <div className={`p-3 rounded-2xl transition-colors duration-500 ${selectedType === option.id ? "bg-[#C9A961] text-black" : "bg-gray-100 text-[#C9A961]"}`}>
                      {option.icon}
                    </div>
          ...
          <div className="w-full lg:w-[400px] space-y-6 lg:sticky lg:top-32">
              ...
              <div className="space-y-8">
                ...
                <div className="pt-6 border-t border-gray-100 space-y-4">
                   <div className="flex justify-between text-sm">
                      <span className="text-gray-400 font-medium">Selected Service</span>
                      <span className="text-black font-bold">{selectedType === 'both' ? 'Floor & Stairs' : selectedType === 'floor' ? 'Floor Only' : 'Stairs Only'}</span>
                   </div>
                   <div className="flex justify-between text-sm">
                      <span className="text-gray-400 font-medium">LVP Thickness</span>
                      <span className="text-[#C9A961] font-black underline underline-offset-4 decoration-current/30">8.5mm Upgrade</span>
                   </div>
                </div>
...
const LadderIcon = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M19 3v18" /><path d="M5 3v18" /><path d="M5 7h14" /><path d="M5 12h14" /><path d="M5 17h14" />
  </svg>
);
